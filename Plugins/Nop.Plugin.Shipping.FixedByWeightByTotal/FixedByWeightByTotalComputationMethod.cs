...
namespace Nop.Plugin.Shipping.FixedByWeightByTotal
{
    ...
    public class FixedByWeightByTotalComputationMethod : BasePlugin, IShippingRateComputationMethod
    {
        ...
        private bool GetFreeShippingStatus(int shippingMethodId)
        {
            return _settingService.GetSettingByKey<bool>(string.Format(FixedByWeightByTotalDefaults.FreeShippingSettingsKey, shippingMethodId));
        }
        ...
        public override void Install()
        {
            ...
            //ADDED FOR FREE SHIPPING 
            _localizationService.AddOrUpdatePluginLocaleResource("Plugins.Shipping.FixedByWeightByTotal.Fields.IsFreeShipping", "Is Free Shipping");
            _localizationService.AddOrUpdatePluginLocaleResource("Plugins.Shipping.FixedByWeightByTotal.Fields.IsFreeShipping.Hint", "If not marked as free shipping, then it consider price even product have free shipping enable");
        ...
        public override void Uninstall()
        {
            ...
            //ADDED FOR FREE SHIPPING
            var freeShipping = _shippingService.GetAllShippingMethods()
                .Select(shippingMethod => _settingService.GetSetting(
                    string.Format(FixedByWeightByTotalDefaults.FreeShippingSettingsKey, shippingMethod.Id)))
                .Where(setting => setting != null).ToList();
            _settingService.DeleteSettings(freeShipping);
            ...
            //ADDED FOR FREE SHIPPING 
            _localizationService.DeletePluginLocaleResource("Plugins.Shipping.FixedByWeightByTotal.Fields.IsFreeShipping");
            _localizationService.DeletePluginLocaleResource("Plugins.Shipping.FixedByWeightByTotal.Fields.IsFreeShipping.Hint");
